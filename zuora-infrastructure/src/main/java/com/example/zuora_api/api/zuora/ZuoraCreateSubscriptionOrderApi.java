...
import com.example.zuora_api.api.zuora.builder.CreateOrderRequestBuilder;
import com.example.zuora_api.api.zuora.builder.PreviewOrderRequestBuilder;
...
@Slf4j
@AllArgsConstructor
public class ZuoraCreateSubscriptionOrderApi implements CreateSubscriptionOrderApi {

  private final ZuoraClient zuoraClient;

  private final PreviewOrderRequestBuilder previewOrderRequestBuilder;
  ...
  public PreviewOrderDto previewSubscription(CreateSubscriptionOrderRequest domainRequest) {
    ...
    var request = previewOrderRequestBuilder.create(domainRequest);
  ...
  public String createSubscription(CreateSubscriptionOrderRequest domainRequest) {
    ...
    var request = createOrderRequestBuilder.create(domainRequest);
    var orderNumber = "";
